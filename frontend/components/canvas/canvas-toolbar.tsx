...
export interface CanvasToolbarProps {
  ...
  readonly onSkipDiscussionTurn?: () => void;
    ...
    <div className={cn('flex items-center', className)}>
      ...
      <div className="flex-1 flex items-center justify-center min-w-0">
        <div className="inline-flex items-center gap-0.5 bg-gray-100/60 dark:bg-gray-800/60 rounded-lg px-1 h-7">
          ...
          {/* Skip the current turn without ending the discussion. */}
          {showStopDiscussion && onSkipDiscussionTurn && (
            <button
              onClick={(e) => {
                e.stopPropagation();
                onSkipDiscussionTurn();
              ...
              className={cn(
                ...
                'hover:bg-violet-500/20 dark:hover:bg-violet-400/20 active:scale-95 transition-all cursor-pointer',
              )}
              title="跳到下一条发言（停止当前语音）"
            >
